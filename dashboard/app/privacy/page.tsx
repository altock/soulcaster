        ...
        <div className="bg-slate-900/80 backdrop-blur-xl border border-white/10 shadow-2xl rounded-lg p-8">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-slate-200 mb-3">1. GitHub Account Information</h3>
              ...
              <ul className="list-disc list-inside text-slate-300 mb-4 ml-4 space-y-1">
                ...
                <li>An OAuth access token with <code className="bg-slate-700 px-1 py-0.5 rounded">repo</code> and <code className="bg-slate-700 px-1 py-0.5 rounded">read:user</code> scopes</li>
              </ul>

              <h3 className="text-xl font-semibold text-slate-200 mb-3">2. Repository Access</h3>
              <p className="text-slate-300 mb-3">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-300 mb-3">We use your information to:</p>
              <ul className="list-disc list-inside text-slate-300 mb-4 ml-4 space-y-2">
                <li>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-slate-200 mb-2">Token Storage</h3>
                  <p className="text-slate-300">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-200 mb-2">Data Persistence</h3>
                  <p className="text-slate-300">
                    We store:
                  </p>
                  <ul className="list-disc list-inside text-slate-300 mt-2 ml-4 space-y-1">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-300 mb-4 ml-4 space-y-2">
                <li>
                  ...
                  (<a href="https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:text-emerald-300 hover:underline">Privacy Policy</a>)
                </li>
                <li>
                  <strong>E2B:</strong> For secure sandbox execution of code generation
                  (<a href="https://e2b.dev/privacy" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:text-emerald-300 hover:underline">Privacy Policy</a>)
                </li>
                <li>
                  <strong>Google Gemini:</strong> For LLM-powered embeddings and code generation
                  (<a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:text-emerald-300 hover:underline">Privacy Policy</a>)
                </li>
                <li>
                  <strong>Upstash Redis:</strong> For data storage
                  (<a href="https://upstash.com/privacy" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:text-emerald-300 hover:underline">Privacy Policy</a>)
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-3">
                <div>
                  <h3 className="text-lg font-semibold text-slate-200 mb-2">Revoke Access</h3>
                  <p className="text-slate-300">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-200 mb-2">Delete Your Data</h3>
                  <p className="text-slate-300">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-200 mb-2">Data Portability</h3>
                  <p className="text-slate-300">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-300 mt-3">
                <strong>Email:</strong>{' '}
                <a href="mailto:support@soulcaster.dev" className="text-emerald-400 hover:text-emerald-300 hover:underline">
