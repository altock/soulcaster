...
class FeedbackItem(BaseModel):
    ...
    This model normalizes feedback from different sources (Reddit, Sentry, manual, GitHub, Splunk)
    ...
    Attributes:
        ...
        source: The origin of the feedback (reddit, sentry, manual, github, or splunk)
    ...
    id: UUID
    project_id: Union[str, UUID]  # Supports both UUID and CUID formats
    source: Literal["reddit", "sentry", "manual", "github", "splunk", "posthog"]
